...
theme.font          = 'VictorMono Nerd Font SemiBold 9'
...
theme.bg_empty      = '#b9b9b940'
theme.fg_occupied   = theme.gtk.wm_border_focused_color
...
theme.tasklist_font_focus = theme.gtk.font
...
theme.titlebar_font_normal = theme.gtk.font
...
theme.titlebar_font_focus = theme.gtk.font

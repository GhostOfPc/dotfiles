...
# SUPER + FUNCTION KEYS
    ...
    Key([mod], "Escape", lazy.spawn(home + '/.local/bin/dmenu_shutdown.sh')),
...
# SUPER + SHIFT KEYS
    ...
    Key([mod, "shift"], "d", lazy.spawn("dmenu_run -i -h 44")),
...
# INCREASE/DECREASE BRIGHTNESS
    Key([], "XF86MonBrightnessUp", lazy.spawn(home + '/.local/bin/brightness.sh up')),
    Key([], "XF86MonBrightnessDown", lazy.spawn(home + '/.local/bin/brightness.sh down')),

# INCREASE/DECREASE/MUTE VOLUME
    Key([], "XF86AudioMute", lazy.spawn(home + '/.local/bin/volume.sh mute')),
    Key([], "XF86AudioLowerVolume", lazy.spawn(home + '/.local/bin/volume.sh down')),
    Key([], "XF86AudioRaiseVolume", lazy.spawn(home + '/.local/bin/volume.sh up')),
...
group_labels = ["TERM", "WEB", "EDIT", "FILES", "MUSIC", "VIDS",]
...
layouts = [
    layout.MonadTall(margin=8, border_width=2, border_focus="#7575ff", border_normal="#1b1d1e"),
    layout.MonadWide(margin=8, border_width=2, border_focus="#7575ff", border_normal="#1b1d1e"),
...
def init_widgets_list():
    ...
    widgets_list = [
               widget.GroupBox(font="FiraMono Nerd Font",
                        fontsize = 26,
                        borderwidth = 0,
                        disable_drag = True,
                        active = colors[9],
               ...
               widget.WindowName(font="FiraMono Nerd Font",
                        fontsize = 26,
                        foreground = colors[5],
                        background = colors[1],
                        ),
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), size=40)),
